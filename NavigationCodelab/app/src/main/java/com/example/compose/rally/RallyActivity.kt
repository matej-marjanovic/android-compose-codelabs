...
fun RallyApp() {
    RallyTheme {
        ...
        val currentScreen: RallyDestination = rallyTabRowScreens.find { rallyDestination ->
            rallyDestination.route == (currentDestination?.route ?: "No route")
        } ?: Overview
...
private fun NavHostController.navigateToSingleAccount(accountType: String) {
    Log.d("RallyActivity", accountType)
